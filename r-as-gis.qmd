...
## Custom Function
To help query the HERE API, there is one user-defined `tryLocation` function to source (courtesy of [Hannah Recht](https://www.hrecht.com/r-drive-time-analysis-tutorial/tutorial.html)). 
