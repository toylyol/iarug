...
color_icon <- awesomeIcons(
  ...
  iconColor = 'black',
  library = 'fa',
  markerColor = ifelse(hospitals$inpatient == 'Yes', 'green', 'gray')) # can't use HEX codes
...
# customizing font color in SCSS: https://quarto.org/docs/presentations/revealjs/themes.html

# creating custom callout: https://www.andreashandel.com/posts/2023-06-13-custom-callouts-quarto/

# customizing callouts: https://github.com/quarto-dev/quarto-cli/discussions/4755

# creating grid div: https://github.com/quarto-dev/quarto-cli/discussions/9029
...
# TODO: Add listing page-style grid with images of other other GIS outputs.
