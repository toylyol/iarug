...
Consider what steps you would have to take if you wanted to see which parts of `r params$state` do not have a hospital within inpatient labor and delivery (L&D) units within a 45-minute drive.
...
Obtain a list of `r params$state` hospitals with L&D from the CMS [Provider Data Catalog](https://data.cms.gov/provider-data/dataset/nrdb-3fcy).
...
A sample of the raw results will be shown here.
...
# TODO: Reduce slide margins.
# TODO: Create custom callout.
